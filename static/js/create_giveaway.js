hey I reverted back to the old one as I told you which is 5 days ago that we discuss about and here are the html and js codes for create_giveaway.html please update the js code to function as before.  html code: <!DOCTYPE html>
    ...
    <div class="container">
        ...
        <form id="create_giveaway_form">
            ...
            <div class="form-group">
                ...
                <p class="info">Please add a channel first to select it here.</p>
